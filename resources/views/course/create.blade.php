...
@section('content')
    ...
    <form method="post" action="/course">
        ...
        <div class="form-group">
            ...
            <input type="text" name="course_name" class="form-control" id="course-name" aria-describedby="courseNameHelp" placeholder="Enter course name">
        ...
        <div class="form-group">
            ...
            <input type="time" name="course_date_time" class="form-control" id="course-date-time" aria-describedby="courseTimeHelpText" placeholder="00:00 00r">
